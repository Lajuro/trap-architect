  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <HudPanel>
          <h1 className="text-[11px] font-bold text-center mb-1 uppercase tracking-wider">Criar Conta</h1>
          ...
          <form onSubmit={handleSignup} className="space-y-3 mb-4">
            <div>
              <label htmlFor="nickname" className="block text-[8px] font-bold mb-1 uppercase tracking-wider">Nickname</label>
              <input
                id="nickname"
                type="text"
                value={nickname}
