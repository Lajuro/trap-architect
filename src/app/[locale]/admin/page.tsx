    ...
    <main className="flex-1 max-w-7xl mx-auto px-4 py-6 w-full overflow-y-auto">
        <HudPanel variant="danger" className="mb-6">
          <h1 className="text-[11px] font-bold uppercase tracking-wider flex items-center gap-2">
            <PixelIcon name="crown" size={16} color="#EF4444" /> {t("title")}
          </h1>
        ...
        <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {level.featured && (
                    <span className="flex items-center gap-1 text-[7px] text-yellow-400 uppercase tracking-wider">
                      <PixelIcon name="star" size={10} color="#FFD700" /> {t("featured")}
                    </span>
                  )}
                </div>
          ...
          {levels.length === 0 && (
            <HudPanel className="text-center py-12">
              <p className="text-[9px] text-muted-foreground">{t("noLevels")}</p>
            </HudPanel>
          )}
        </div>
        ...
        <HudPanel variant="danger" className="mt-8 mb-4">
          <h2 className="text-[11px] font-bold uppercase tracking-wider flex items-center gap-2">
            <PixelIcon name="flag" size={14} color="#EF4444" /> {t("reports")}
          </h2>
        </HudPanel>
        {reports.length === 0 ? (
          ...
          <div className="space-y-2">
            {reports.map((report) => {
              ...
              const reasonLabels = (key: string) => t(`reasons.${key}`) || key;
              return (
